...
description: "From paper appraisals to a low-code platform with ML-driven property value predictions."
date: 2024-03-03
type: Case Study
...
outcomes:
  ...
  - { value: "27", caption: "predictive indicators per zone" }
---
...
**They saw potential in all the data stored from years**, plus the information going on during operational tasks so they could _run an algorithm_ and predict square meter's value per zone. **It could reduce at least half operational tasks and costs, besides maximizing assets value** knowing where to buy, rent, or sublease.
...
![](../attachments/real-estate-operations-producing-future-value-insights-img-1.png)

💡 _[Jump to the Outcome of this project](./#outcome) or continue reading about the releases._
...
![](../attachments/real-estate-operations-producing-future-value-insights-img-2.png)

In parallel, I evaluated our technical possibilities considering **business needs**, the type of **information**, and user **context**. So, I researched and **tested various Low-code technologies** to reduce technical effort and time to market. So I interviewed 6 agencies and hired a [Glide Expert Agency: LowCode](https://www.lowcode.agency/?ref=antonioavalos.com).
...
![](../attachments/real-estate-operations-producing-future-value-insights-img-3.png)
...
![](../attachments/real-estate-operations-producing-future-value-insights-img-4.png)
...
![](../attachments/real-estate-operations-producing-future-value-insights-img-5.png)
...
![](../attachments/real-estate-operations-producing-future-value-insights-img-6.png)

![](../attachments/real-estate-operations-producing-future-value-insights-img-7.png)

![](../attachments/real-estate-operations-producing-future-value-insights-img-8.png)
...
![](../attachments/real-estate-operations-producing-future-value-insights-img-9.jpg)

_O: Full /: Partial x: Invisible_
...
![](../attachments/real-estate-operations-producing-future-value-insights-img-10.png)

![](../attachments/real-estate-operations-producing-future-value-insights-img-11.png)

![](../attachments/real-estate-operations-producing-future-value-insights-img-12.png)

![](../attachments/real-estate-operations-producing-future-value-insights-img-13.png)
...
![](../attachments/real-estate-operations-producing-future-value-insights-img-14.png)

![](../attachments/real-estate-operations-producing-future-value-insights-img-15.png)
...
![](../attachments/real-estate-operations-producing-future-value-insights-img-16.png)
